...
You should have at this point already made sure you've set up R according to the Fundamentals and have already run your first commands in R.
...
This may seem like a minor difference, but an important part of coding is legibility - by always ensuring the data is on the left, you can help someone unfamiliar with your code to figure out what each component does. We'll see more about pipes later.
...
> EXERCISE: Modify the same plot to show LMIC category with a shape parameter instead of a color parameter. Label the plot.
