...
#--- Filter to just Zimbabwe
sdg %>% select(country, reg) %>% filter(country == "Zimbabwe") %>% head()
...
Voila - a beautiful plot! It is clear that countries that make up a small cumulative percentage of GDP account for a large cumulative percentage of TB cases. We can clearly see from our vertical line that the countries making up the lowest 10% of GDP account for about 50% of all total TB cases.
